...
class Pokemon {
    ...
    func downloadPokemonDetail(completed: @escaping DownloadComplete) {
        let headers: HTTPHeaders = [
            "Cookie": "__cfduid=d32531b014ccd08f432aa3c8bf83e9eef1493894703; _ga=GA1.2.153954551.1493894711; _gid=GA1.2.597125974.1493896505; cf_clearance=c4ebc79811accf63faa4161ef8b1b95e15f08528-1493965622-300",
            "Accept": "application/json"
        ]
        
        Alamofire.request(_pokemonURL, headers: headers).responseJSON{ (response) in
            /// TODO: Figure out how to access pokeapi without having to input captcha
